<script lang="ts">
	...
	import UpgradePlanModel from "$lib/components/UpgradePlanModel.svelte";
...
<CreateContactModal data={data.createContactForm} bind:open={createContactOpen}/>
<DeleteContactModal data={data.deleteContactForm} contactId={contactToDelete} bind:open={deleteContactOpen}/>
<UpgradePlanModel bind:open={upgradeModalOpen} {tier} message="You have reached the max contacts for your plan. Please upgrade to add more.">
