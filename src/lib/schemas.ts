...
export const createContactSchema = z.object(
    {
        ...
        phone: z.string().max(64, "Phone must be 65 characters or less").nullish()
...
export type DeleteContractSchema = typeof deleteContactSchema;
...
export const stripeSubscriptionItemsSchema = z.object({
    ...
    data: z.array(
        ...
        z.object({
            // price property
            price: z.object({
                // price object has a product property
                product: z.string(),
            })
        })
    ),
